...
#SBATCH --output=/home/vaganeeva/chem_augm_finetune/logs/eval_finetuned_multitask-text-and-chemistry-t5-base-augm_1e-4_augm_test_from_test.log       # Файл для вывода результатов
...
--max_length 512 \
--batch_size 16 \
--output_dir "/home/vaganeeva/chem_augm_finetune/mol/evaluation_results/augm_multitask-text-and-chemistry-t5-base-augm_lr1e-4_augm_test/${i}" \
--output_pred_file "/home/vaganeeva/chem_augm_finetune/mol/evaluation_results/augm_multitask-text-and-chemistry-t5-base-augm_lr1e-4_augm_test/epoch_${i}_pred.tsv";
done
